...
<?php
		...
		function form( $instance ) {
			...
			<p>
				...
				<input type="text" id="<?php echo $this->get_field_id( 'pageurl' ); ?>" name="<?php echo $this->get_field_name( 'pageurl' ); ?>" value="<?php echo $instance['pageurl']; ?>" class="widefat" /><br />
			...
			<p>
				...
				<input type="text" id="<?php echo $this->get_field_id( 'width' ); ?>" name="<?php echo $this->get_field_name( 'width' ); ?>" value="<?php echo $instance['width']; ?>" class="widefat" /><br />
				<small>* Default: <strong>300</strong> </small>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id( 'bordercolor' ); ?>">Box Border Color:</label>
				<input type="text" id="<?php echo $this->get_field_id( 'bordercolor' ); ?>" name="<?php echo $this->get_field_name( 'bordercolor' ); ?>" value="<?php echo $instance['bordercolor']; ?>" class="widefat" /><br />
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'color_scheme' ); ?>">Facebook Color Scheme:</label>
